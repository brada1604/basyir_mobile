                    ...
                    <div class="d-flex align-items-end justify-content-center" style="background-color: white; border-radius: 20px; height: 550px;">
                        <div class="text w-100">
                            <nav class=" navbar container">
                                <h5 style="font-family: 'Inter',Arial, sans-serif; color: #629C87;">Izinkan Untuk Melakukan <br> Broadcast Email</h5>
                                
                            </nav>
                            <br>
                            <nav class=" navbar container">
                                <h5 style="font-family: 'Inter',Arial, sans-serif; color: #629C87; margin-bottom: 320px;">Masukkan Nomor <br> Whatsapp Anda</h5>
                            </nav>
                        </div>
                    </div>
                </div>
