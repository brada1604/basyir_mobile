                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-end justify-content-center" style="background-color: white; border-radius: 20px; height: 550px;">
                        <div class="text w-100">
                            <nav class=" navbar container" style="margin-top: -500px; margin-left: 10px;">
                                <h5 style="font-family: 'Inter',Arial, sans-serif; color: #629C87;">Aktifkan Notifikasi</h5>
                                <div class="form-check-inline form-check form-switch mb-4" style="font-family: 'Inter', Arial, sans-serif; color: #629C87; font-weight: bold; margin-bottom: 300px;">
